...
ceph::io_exerciser::json::JSONStructure
  ::JSONStructure(std::shared_ptr<ceph::Formatter> formatter) :
  formatter(formatter)
{
}
...
ceph::io_exerciser::json::OSDMapRequest
...
ceph::io_exerciser::json::OSDECPoolCreateRequest
...
ceph::io_exerciser::json::OSDSetRequest
...
ceph::io_exerciser::json::BalancerOffRequest
  ::BalancerOffRequest(std::shared_ptr<ceph::Formatter> formatter) :
  JSONStructure(formatter)
{
...
ceph::io_exerciser::json::BalancerStatusRequest
...
ceph::io_exerciser::json::BalancerStatusReply
...
ceph::io_exerciser::json::ConfigSetRequest
...
void ceph::io_exerciser::json::InjectECClearErrorRequest
